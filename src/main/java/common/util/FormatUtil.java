...
public class FormatUtil {
    ...
    /**
     * <pre>
     * 1. MethodName : formatDateTime
     * 2. ClassName  : FormatUtil.java
     * 3. Comment    : yyyyMMddhhmmss 형식의 날짜문자열을 원하는 캐릭터(ch)로 쪼개 돌려준다<br/>
     * 4. 작성자       : upleat
     * 5. 작성일       : 2020. 3. 18.
     * </pre>
     *
     ...
     * @return
     */
    public static String formatDateTime(String sDate, String ch) {
        if (sDate.length() == 14) {
            return formatDate(sDate.substring(0, 8), ch) + formatTime(sDate.substring(8, 14), ":");
        } else {
            return "";
        }
    }
    ...
    /**
     * 기능 : 3개의 문자열로 나뉘어져 있는 전화번호를 "-"으로 연결된 하나의 문자열로 변환하여 반환한다. 입력화면에서 나뉘어져 있는
     * 각각의 전화번호 필드를 DB의 하나의 Column에 넣을때 사용한다. param str1 지역번호 param str2 국번
     * param str3 번호
     * 
    ...
    public static String convTelNumber(String telNumber, String delimeter) {
        ...
        if (resultText.indexOf(")") >= 0 || resultText.indexOf("-") >= 0 || resultText.length() < 7) {
            ...
            if (resultText.substring(0, 2).equals("02") && totalSize > 7) {
                ...
                if (totalSize > 8 && (areaNum.equals("031") || areaNum.equals("032") || areaNum.equals("033") || areaNum.equals("041") || areaNum.equals("042") || areaNum.equals("043") || areaNum.equals("051") || areaNum.equals("052")
                        || areaNum.equals("053") || areaNum.equals("054") || areaNum.equals("055") || areaNum.equals("061") || areaNum.equals("062") || areaNum.equals("063") || areaNum.equals("064") || areaNum.equals("010")
                        || areaNum.equals("011") || areaNum.equals("016") || areaNum.equals("017") || areaNum.equals("018") || areaNum.equals("019") || areaNum.equals("012") || areaNum.equals("015"))) {
    ...
    /**
     * 기능 : 우편번호 6자리를 받아 3자리씩 끊어 flag로 구분하여 연결한 문자열로 반환한다. param zipcode
     * 우편번호(하나의 문자열)
     * 
     * @return String[] 우편번호
     */
    ...
    /**
     * 기능 : 우편번호 6자리를 받아 size가 2인 1차원 배열에 3자리씩 끊어 담아 반환한다. param zipcode
     * 우편번호(하나의 문자열) param flag 구분자
     * 
     * @return String[] 우편번호
     */
    ...
    /**
     * 기능 : 숫자 3자리 당 콤마(,) 찍어 줌 ex) ###,###,###.##### param val 문자형 숫자
     * 
     * @return 결과값
     */
    public static String formatNumber(String val) {
        ...
        if (StringUtil.nullCheck(val) == false && val.length() > 0) {
            ...
            if ((val.indexOf(".")) != -1) {
                if ((val.length() - 1) > val.indexOf("."))
                    ls_num02 = val.substring(val.indexOf("."), val.length());
                if ((val.indexOf(".")) == 0)
                    val = "0";
                else
    ...
    /**
     * <pre>
     * 1. MethodName : byteCal
     * 2. ClassName  : FormatUtil.java
     * 3. Comment    : 바이트를 입력받아 MB, KB, GB 등으로 치환
     * 4. 작성자       : upleat
     * 5. 작성일       : 2020. 4. 13.
     * </pre>
     *
     ...
     * @return
     */
    public static String byteCal(String bytes) {
        String retFormat = "0";
