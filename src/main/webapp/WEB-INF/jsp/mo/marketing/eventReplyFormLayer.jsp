        ...
        <form name="replyForm" id="replyForm" onsubmit="return false">
            ...
            <div class="contain-comment">
                <span class="form-textarea">
                    <textarea name="EVT_RPL_CTS" id="EVT_RPL_CTS" placeholder="해피콜 가능한 시간을 남겨주세요. (예시 4/20 오후4~5시) #콜센터 운영시간: 평일 10:00~19:00." onkeyup="StringUtil.getStrLength(this, '.byte', 600);" maxlength="600"></textarea>
                    <i><span class="byte">0</span>/600</i>
                    <label class="form-alert" message-target="EVT_RPL_CTS" data-name="내용"></label>
                </span>
                <div class="box-form">
                    <span>
                        <input type="text" name="EVT_RPL_NM" id="EVT_RPL_NM" placeholder="이름" maxlength="10"/>
                        <label class="form-alert" message-target="EVT_RPL_NM" data-name="이름"></label>
                    </span>
                    <span style="float:right;">
                        <input type="password" name="EVT_RPL_PW" id="EVT_RPL_PW" placeholder="비밀번호" maxlength="15"/>
                        <label class="form-alert" message-target="EVT_RPL_PW" data-name="비밀번호"></label>
                    </span>
                    <c:if test="${commandMap.EVT_MST_PSN_YN eq 'Y' }">
                        <div>
                            <input type="text" name="EVT_RPL_HP" id="EVT_RPL_HP" class="number" placeholder="연락처를 입력해주세요" maxlength="11"/>
            ...
            <c:if test="${commandMap.EVT_MST_PSN_YN eq 'Y' }">
                <div class="contain-comment">
                    <dl class="box-form">
                        <dt class="necessary">개인정보 수집 및 활용 동의</dt>
                        <dd>
                    ...
                    <label class="form-checkbox"><input type="checkbox" name="EVT_RPL_PSN_YN" value="Y"/>개인정보 수집 및 활용에 동의합니다.</label>
                ...
                <div class="contain-comment">
                    ...
                    <label class="form-checkbox"><input type="checkbox" name="EVT_RPL_MKT_YN" value="Y"/>마케팅 활용에 동의합니다.</label>
                </div>
                <hr class="divline-type2">
            </c:if>
            <div class="contain-comment">
