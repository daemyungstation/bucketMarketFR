...
<div class="area-content">
    <div class="area-inner">
        ...
        <div class="contain-join-body">
            ...
            <p class="text-information-type1">레디플래너 로그인 및 정산에 필요한 <br >추가 정보를 입력해 주세요.</p>
...
<div id="informationPopup" class="layer-popup2 active">
    <div class="layer-inner">
        ...
        <div class="contain-body">
            ...
            <p class="text-normal-type2">레디플래너  로그인 아이디 및 <br >실적 정산에 꼭 필요한 정보가 필요합니다. <br >추가정보 입력페이지로 이동합니다.</p>
