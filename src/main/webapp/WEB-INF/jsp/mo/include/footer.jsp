...
enp('create', 'common', 'bucketmarket', { device: 'M' }); // W:웹, M: 모바일, B: 반응형
...
<footer class="area-footer">
    <div class="area-inner">
        <div class="box-footer-link">
            <span><a href="javascript:fnAppExec();">APP 다운로드</a>
            <!-- 구글 플레이 / 앱스토어 다운로드 추가 -->
            </span>
        ...
        <div class="box-footer-address">
            <span>서울지점(우편수신처) : 서울시 강남구 강남대로 624, 14층(신사동, 아이씨티타워)</span>
            <span>본점 : 강원도 홍천군 서면 한치골길 262 (소노호텔앤리조트, 비발디파크)</span>
            <span>(주)대명스테이션  대표이사 최성훈</span>
            <span>사업자등록번호 220-88-09321  |  통신판매신고번호  제 2021-강원홍천-0050호</span>
        </div>
