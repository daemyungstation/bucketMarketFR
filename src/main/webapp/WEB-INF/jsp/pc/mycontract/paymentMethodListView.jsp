...
<jsp:include page="/WEB-INF/jsp/pc/include/nav.jsp" flush="false">
    ...
    <jsp:param name="twoDepth" value="결제수단 변경 신청"/>
    <jsp:param name="twoDepthKey" value="mycontract.paymentmethod.list.view"/>
</jsp:include>
        ...
        <div class="wrap">
            ...
            <div class="contain-body">
                <div class="content-header">
                    <h3 class="title">결제수단변경 신청</h3>
                </div>
                
                <div class="area-mypage">
                    <div class="box-information">
                        <ul class="text-information-list1">
                            <li>가입하신 상품의 상조 월부금 납입 결제수단을 변경할 수 있습니다.</li>
                        </ul>
                    </div>
                            ...
                            <c:when test="${fn:length(list) gt 0 }">
                                ...
                                <c:forEach var="item" items="${list }">
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="join-state">가입(<c:out value="${item.PAY_MTHD_NM }"/>)</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <p class="btn-member contract" data-idx="<c:out value="${item.ORD_MST_IDX }"/>">
                                        <span class="btn-type-text7 type2"><button class="card">카드결제 변경신청</button></span>
                                        <span class="btn-type-text7 type2"><button class="cms">CMS결제 변경신청</button></span>
                                    </p>
...
<script>
    $(function () {
        ...
        $areaContent.on("click", "button.card", function() {
            ...
            $(".layer-popup1").requestLayer($.action.mycontract.paymentmethod.card.layer(), params, "layer-member1");
        });
        // CMS출금 변경 신청
        $areaContent.on("click", "button.cms", function() {
            var params = { ORD_MST_IDX : $(this).closest("p.contract").attr("data-idx") }
            $(".layer-popup1").requestLayer($.action.mycontract.paymentmethod.cms.layer(), params, "layer-member1");
        });
    });
</script>
