                        ...
                        <form name="replyRegistForm" id="replyRegistForm" onsubmit="return false">
                            <div class="form-comment">
                                ...
                                <span class="form-textarea">
                                    ...
                                    <textarea name="EVT_RPL_CTS" id="EVT_RPL_CTS" onkeyup="StringUtil.getStrLength(this, '.byte', 600);" maxlength="600" placeholder="해피콜 가능한 시간을 남겨주세요. (예시 4/20 오후4~5시) #콜센터 운영시간: 평일 10:00~19:00."></textarea>
                                ...
                                <c:if test="${info.EVT_MST_PSN_YN eq 'Y' }">
                                    <div class="box-form" style="clear:both; width:100%;">
                                        <span>
                                            <input type="text" name="EVT_RPL_HP" id="EVT_RPL_HP" class="number" placeholder="연락처를 입력해주세요" maxlength="11" style="width:476px">
                                    ...
                                    <dl class="box-form">
                                        ...
                                        <dd>
                                            ...
                                            <div class="agreement-checkbox">
                                                <label class="form-checkbox type2" style="float:none;padding-bottom:20px;"><input type="checkbox" name="EVT_RPL_PSN_YN" value="Y">개인정보 수집 및 활용에 동의합니다.</label>
