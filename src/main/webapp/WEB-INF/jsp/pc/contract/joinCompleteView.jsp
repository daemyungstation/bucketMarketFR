...
enp('create', 'conversion', 'bucketmarket', { device: 'W', convType: 'join', productName: '<c:out value="${commandMap.PRD_MST_NO}"/>'}); // 디바이스 타입  W:웹, M: 모바일, B: 반응형
enp('send', 'conversion', 'bucketmarket', { device: 'W', convType: 'join', productName: '<c:out value="${commandMap.PRD_MST_NO}"/>'});
</script>
<!-- Enliple Tracker End -->
<body class="">
    ...
    <div class="area-body">
        <div class="area-top-type3">
            <form id="reviewForm" name="reviewForm">
                ...
                <div class="area-inner pt">
                    <div class="contain-order-inner">
                        <div class="contain-step">
                            <div class="box-information-appresult">
                                <p class="text-information-type1 notice2"><span class="text-point2">간편상담 신청이 완료되었습니다.</p>
                                <p class="text-information-type2">버킷마켓 고객센터 (1644-8399) 전화를 꼭 받아주세요.</p>
                            </div>
                            ...
                            <div class="box-reviewwrite" style="max-width: 460px;margin: 0 auto;">
                                <p class="text-normal-type2">신청후기를 남겨주세요.</p>
                                <span class="form-textarea">
                                    <textarea name="PRD_REV_CTS" placeholder="내용을 입력해 주세요." onkeyup="StringUtil.getStrLength(this, '.byte', 500);"></textarea>
                                    <i><span class="byte">0</span>/500</i>
                                </span>
                            </div>
            
                            <%-- <div class="box-addphoto" style="max-width: 460px;margin: 0 auto;">
