            ...
            <div>
                ...
                <form id="frm" name="frm">
                    ...
                    <div class="box-findpassword">
                        <p class="text-normal-type1-1">비밀번호를 찾고자 하는 아이디를 입력해 주세요.</p>
                        <input type="text" name="RDP_MST_ID" value="<c:out value="${commandMap.RDP_MST_ID }" />" maxlength="20" >
                        <p class="text-normal-type1-1 text-point1">비밀번호는 가입된 명의자의 휴대폰 본인확인을 통해 새로운 비밀번호로 설정됩니다.</p>
                    </div>
    ...
    <div class="layer-popup2 active">
        <div class="layer-inner">
            ...
            <div class="contain-body">
                ...
                <p class="text-normal-type2-1">입력된 정보의 가입 이력이 확인되지 않습니다. <br >정확한 정보를 입력해 주세요.</p>
