...
<div class="area-body">
    <div class="area-inner">
        ...
        <div class="contain-login">
            ...
            <div class="contain-join-head quiz">
            ...
            <div class="contain-join-body quiz">
                <p class="text-information-type1">레디플래너 학습 동영상을 시청하고 퀴즈를 풀어주세요.<br >퀴즈의 정답을 모두 맞추셔야 레디플래너 활동이 가능합니다. <span class="text-notice-type2 form">* 필수</span></p>
...
<div id="informationPopup" class="layer-popup2 active">
    <div class="layer-inner">
        ...
        <div class="contain-body">
            ...
            <p class="text-normal-type2-1">레디플래너 활동을 위한 마지막 미션 절차가 <br >남았습니다. 미션페이지로 이동합니다.</p>
...
<div id="popupFail" class="layer-popup2">
    <div class="layer-inner">
        ...
        <div class="contain-body">
            ...
            <p class="text-normal-type2-1">미션을 통과하지 못하셨습니다. <br >다시 시도해 주세요.</p>
            <div class="box-button">
...
<div id="popupSuccess" class="layer-popup2">
    <div class="layer-inner">
        ...
        <div class="contain-body">
            ...
            <p class="text-normal-type2-1">미션을 성공적으로 수행하셨습니다. <br >다양한 활동으로 수익창출의 기회를 잡으세요.</p>
            <div class="box-button">
