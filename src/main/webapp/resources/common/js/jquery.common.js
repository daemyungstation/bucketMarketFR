$(function () {
    var $header = $(".area-header"),
        ...
        $body = $(".area-body"),
        $layerPopup = $(".layer-popup1, .layer-popup2, .layer-popup4, .layer-popup5"),
        ...
        common : {
            ...
            layer : {
                ...
                close : function ($layer) {
                    ...
                    } else if ($layer.hasClass("layer-popup5")) {
                        $layer
                            .removeClass()
                            .addClass(["layer-popup", "layer-popup5"]);
                        if (!$layer.siblings(".layer-popup1").hasClass("active") && !$.resources.isPc) {
                            scrollAble();
                        }
                    }
            ...
            check : {
                ...
                /**
                 * <pre>
                 * 1. FuntionName : common.check.oneselfMove
                 * 2. ClassName  : jquery.common.js
                 * 3. Comment    : 본인인증
                 * 4. 작성자       : upleat
                 * 5. 작성일       : 2020. 5. 13.
                ...
                oneselfMove : function (addVar) {
                    ...
                    $.postSyncJsonAjax($.action.common.oneself.req.num.ajax(), null, function (data) {
                        $.oneselfReqNum = data.reqNum;
                        $oneselfForm.append(TagUtil.createDynamicInput("hidden", "reqNum", $.oneselfReqNum));
                        $oneselfForm.append(TagUtil.createDynamicInput("hidden", "addVar", addVar));
                    });
                    if ($.oneselfReqNum) {
                        $.requestPage($.action.common.oneself.req.popup(), $oneselfForm.serializeObject());
                    }
