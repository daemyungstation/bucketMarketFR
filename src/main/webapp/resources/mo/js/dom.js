$(window).on('load',function(){
    ...
    //0807 추가
    if($('.box-tab-head').length > 0){
        posTab1 = $('.contain-product2').offset().top
    }
...
$(window).on('scroll',function(event){
    ...
    if($('.box-tab-head').length > 0){
        ...
        if(posTab1 < $(window).scrollTop() && $('body').hasClass('active') == 0){
            $('.contain-product2').addClass('on-h')
        }else{
            $('.contain-product2').removeClass('on-h')
        }

        if($(window).scrollTop() > posTab1 ){
            $('.contain-product2').addClass('active');
        }else{
            $('.contain-product2').removeClass('active');
        }
    }
