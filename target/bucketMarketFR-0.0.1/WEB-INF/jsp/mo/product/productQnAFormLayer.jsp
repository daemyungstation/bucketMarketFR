    ...
    <div class="area-inner">
        <dl class="detail-product-type1 type1">
            <dd class="image">
                ...
                <span class="ribbon-type1"><c:out value="${basicProductInfo.PRD_MST_SPT_TXT }"/></span>
            </dd>
            <dt>
                ...
                <c:out value="${basicProductInfo.PRD_MST_NM }"/>
            </dt>
        </dl>
        <form name="productQnAForm" id="productQnAForm" onsubmit="return false">
            ...
            <div class="box-qna-write">
                ...
                <dl class="box-form">
                    ...
                    <dd>
                        <input type="text" name="PRD_QNA_MEM_NM" id="PRD_QNA_MEM_NM" value="" maxlength="10"/>
                ...
                <dl class="box-form">
                    ...
                    <dd>
                        <input type="password" name="PRD_QNA_MEM_PW" id="PRD_QNA_MEM_PW" value="" placeholder="비밀번호를 입력해주세요"/>
