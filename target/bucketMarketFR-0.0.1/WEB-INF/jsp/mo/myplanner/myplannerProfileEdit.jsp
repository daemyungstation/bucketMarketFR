...
<jsp:include page="/WEB-INF/jsp/mo/include/header.jsp" flush="false">
    <jsp:param name="headerGroup" value="historyback|title-btn|home"/>
    <jsp:param name="headerTitle" value="프로필 관리"/>
</jsp:include>
<!-- //헤더 -->
<!-- 카테고리 -->
    ...
    <div class="area-inner">
        ...
        <div class="box-profile-form">
            <dl class="box-form fixed">
                <dt>이름</dt>
                <dd><c:out value="${info.RDP_MST_MEM_NM }"/><span class="btn-type-text5 w100"><button id="btnChangePassword">비밀번호 변경</button></span></dd>
            </dl>
            <dl class="box-form fixed">
                <dt>휴대폰 번호</dt>
                <dd><c:out value="${info.RDP_MST_HP1 }"/>-<c:out value="${info.RDP_MST_HP2 }"/>-<c:out value="${info.RDP_MST_HP3 }"/><span class="btn-type-text5 w100"><button id="btnChangePhoneNumber">연락처 변경</button></span></dd>
            </dl>
            <dl class="box-form fixed">
                <dt>이메일 주소</dt>
                <dd><c:out value="${info.RDP_MST_MAIL }"/></span></dd>
            </dl>   
