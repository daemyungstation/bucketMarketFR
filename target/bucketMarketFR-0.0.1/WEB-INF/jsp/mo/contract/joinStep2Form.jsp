                    ...
                    <div class="contain-step on">
                        ...
                        <form name="contractForm" id="contractForm">
                            ...
                            <div class="box-inner">
                                <dl class="box-form">
                                    <dt><i>(필수)</i>가입자 정보</dt>
                                    <dd><input type="text" value="<c:out value="${SessionsUser.USER_NM }"/>" disabled="disabled"/></dd>
                                    <dd>
                                ...
                                <dl class="box-form">
                                    <dd>
                                        <span class="form-birthday type2">
                                            <span class="form-gender <c:if test="${SessionsUser.USER_SEX eq Const.FEMALE }">on</c:if>">여자</span>
                                            <span class="form-gender <c:if test="${SessionsUser.USER_SEX eq Const.MAN }">on</c:if>">남자</span>
                                ...
                                <dl class="box-form">
                                    ...
                                    <dd>
                                        <input type="text" name="HOME_ADDR2" placeholder="상세주소 입력" maxlength="70"/>
                                ...
                                <dl class="box-form">
                                    <dt><i>(필수)</i>해피콜 상담시간 <span class="btn-help"><button class="help2">도움말</button></span></dt>
                                    <dd>
                                        <span class="form-select">
