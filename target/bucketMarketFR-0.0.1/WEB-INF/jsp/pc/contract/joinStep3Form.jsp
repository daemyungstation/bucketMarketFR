            ...
            <div class="area-inner">
                ...
                <div class="contain-order-inner">
                    ...
                    <div class="contain-step">
                        ...
                        <div class="box-certification-kakao">
                            <p class="text-information">고객님의 휴대폰으로 <br >카카오페이 인증요청 메시지가 발송되었습니다. <br>카카오 앱에서 인증을 진행해 주세요.</p>
                            <ul class="step-certification">
                                <li class="step1"><strong>STEP 01</strong>카카오톡에서 <br >메세지 확인</li>
                                <li class="step2"><strong>STEP 02</strong>카카오페이 <br >인증 진행</li>
                                <li class="step3"><strong>STEP 03</strong>인증 완료 후 <br >현재 화면의 <br >인증 완료 출력</li>
                            </ul>
                        </div>
                        <div class="fixed-box-button">
                            <span class="btn-type-text1 request-signature"><button>재요청</button></span>
                            <span class="btn-type-text1 complete-signature disabled"><button>전자서명 인증완료</button></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(function () {
            var $areaBody = $(".area-body"),
                $requestSignature = $areaBody.find(".request-signature"),
                $completeSignature = $areaBody.find(".complete-signature"),
                $joinStepForm = $("#joinStepForm");
            
            <%-- 페이지 로딩 후 앵커 이동 --%>
            $("html, body").animate({
                scrollTop: $(".box-certification-kakao").offset().top
            });
            
            <%-- 재 요청 버튼 클릭 이벤트 --%>
            $areaBody.on("click", ".request-signature", requestSignature);
            <%-- 인증완료 버튼 클릭 이벤트 --%>
            $areaBody.on("click", ".complete-signature", function (e) {
                e.preventDefault();
