...
<body>
        ...
        <div class="area-inner">
            <div class="wrap">
                ...
                <div class="contain-body">
                    ...
                    <div class="box-guide">
                        <p class="guide01"><span>버킷마켓과 파트너를 맺고 싶다면, 지금 바로 문의해 보세요!</span></p>
                    </div>
                    <form name="contactUsForm" id="contactUsForm" onsubmit="return false;">
                        <div class="contain-partner">
                            <p class="text-notice-type3">· 제휴문의는 아래의 모든 항목을 상세히 작성해 주시면, 담당자가 검토 후 2~3영업일 이내에 연락을 드립니다.</p>
                            <p class="text-notice-type2 form2">* 필수입력사항</p>
                            <div class="box-inquiry type2">
                                <p class="box-inquiry-title">정보입력</p>
                                <dl class="box-form">
                                ...
                                <dl class="box-form addi">
                                    ...
                                    <dd>
                                        <span class="form-w300">
                                            <input type="text" name="CTT_US_TITLE" id="CTT_US_TITLE" value="" onkeyup="StringUtil.getStrLength(this, '.title-byte', 200);" maxlength="170">
                            ...
                            <div class="box-inquiry type2">
                                ...
                                <label class="form-alert alert-right" message-target="CTT_US_PSN_YN" data-name="개인정보 수집 및 활용"></label>
                            </div>
                        </div>
    ...
    <script id="contactUsCompleteTemplate" type="text/x-jquery-tmpl">
        <div class="contain-partner">
            <p class="text-notice-type3">· 제휴문의는 아래의 모든 항목을 상세히 작성해 주시면, 담당자가 검토 후 2~3영업일 이내에 연락을 드립니다.</p>
            <div class="box-partner-complete">
    ...
    <script>
        $(function () {
            var $areaBody = $(".area-body"),
                $contactUsForm = $areaBody.find("#contactUsForm");
