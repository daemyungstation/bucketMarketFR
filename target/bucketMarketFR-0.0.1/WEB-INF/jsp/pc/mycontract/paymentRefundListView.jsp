...
<jsp:include page="/WEB-INF/jsp/pc/include/nav.jsp" flush="false">
    ...
    <jsp:param name="twoDepth" value="납입/환급금 조회"/>
    <jsp:param name="twoDepthKey" value="mycontract.paymentrefund.list.view"/>
</jsp:include>
        ...
        <div class="wrap">
            ...
            <div class="contain-body">
                <div class="content-header">
                    <h3 class="title">납입/환급금 조회</h3>
                </div>
                
                <div class="area-mypage">
                    <div class="box-information">
                        <ul class="text-information-list1">
                            <li>회원번호나 상품명을 선택하시면 상세정보를 확인할 수 있으며, 보다 자세한 상품 정보는 납입증서를 참고하시기 바랍니다.</li>
                        </ul>
                    </div>
...
<script>
    $(function () {
        ...
        $areaContent.on("click", "button.detail", function() {
            ...
            $(".layer-popup1").requestLayer($.action.mycontract.paymentrefund.detail.view.layer(), params, "layer-member1");
        });
        // 환급금 조회
        $areaContent.on("click", "button.refund", function() {
            var params = { ORD_MST_IDX : $(this).closest("p.contract").attr("data-idx") }
            $(".layer-popup1").requestLayer($.action.mycontract.paymentrefund.refund.view.layer(), params, "layer-member1");
        });
    });
</script>
</body>
