...
public class ProductDisplayServiceImpl implements ProductDisplayService {
    ...
    public List<Map<String, Object>> selectCategroyListByBestProduct(String code) throws Exception {      
        return (List<Map<String, Object>>) defaultDAO.selectList("ProductDisplay.selectCategroyListByBestProduct"
                , Code.class.getDeclaredField(code).get(Code.class).toString());     
    }
