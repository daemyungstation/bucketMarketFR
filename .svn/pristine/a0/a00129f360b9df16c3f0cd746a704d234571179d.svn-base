        ...
        <div class="area-top-type3">
            <div class="area-inner">
                ...
                <div class="contain-order-inner">
                    <h3 class="title">누적 100만 회원이 이용한 혜택<br>부담없이 상담 먼저 받아보세요.</h3>
                    <div class="contain-step">
                        <form name="contractForm" id="contractForm">
                            ...
                            <div class="box-step-form">
                                <dl class="box-form">
                                    <dt>희망 상담시간 <i>(필수)</i></dt>
                                    <dd class="type3">
                                        <p class="text-normal-type1">* 신청 완료 후, 전문 상담원이 해피콜을 드립니다. 통화 가능한 시간대를 선택해 주세요</p>
                            ...
                            <div class="box-inner">
                                <div class="btn-agree-title"><span class="btn-agree-title" style="text-align: left;">
                                        ...
                                        <c:choose>
                                            <c:when test="${row.CMN_COM_UP_IDX ne term_group }">
                                                ...
                                                <span class="act-agreement">
                                                    <label class="form-checkbox form-checkbox-w1 row-agreement" data-cmn_com_idx="<c:out value="${row.CMN_COM_IDX }"/>" data-agr_mst_title="<c:out value="${row.CMN_COM_ETC3 }"/>">
                                                        <c:choose>
                                                    ...
                                                    <span class="btn-agree-check" data-cmn_com_idx="<c:out value="${row.CMN_COM_IDX }"/>" data-cmn_com_up_idx="<c:out value="${row.CMN_COM_UP_IDX }"/>" data-agr_mst_title="<c:out value="${row.CMN_COM_ETC3 }"/>"><button><span></span></button></span>
                                                    <!-- 개인정보 이용약관 -->
...
<%--                                                                        </div>--%>
    ...
    <script>
        $(function () {
            ...
            <%-- 약관 전체동의 펼쳐보기 클릭 이벤트 --%>
            $areaBody.on("click", "#allagree-expend", function (e) {
                e.preventDefault();
                if($("#box-agreement").css('display') == 'none') {
                    $("#box-agreement").slideDown('fast');
                    $("button.allagree-expend span").css({'transform':'rotate(315deg)', 'top':'5px'});
                }else {
                    $("#box-agreement").slideUp('fast');
                    $("button.allagree-expend span").css({'transform':'rotate(135deg)', 'top':'-5px'});
                }
            });
            <%-- 약관 전체동의 버튼 클릭 이벤트 --%>
            ...
            $areaBody.on("click", ".btn-agree-check", function (e) {
                ...
                $(".btn-agree-check button span").css({'transform':'rotate(135deg)', 'top':'-8px'});
                ...
                if($("#term-area-"+cmm_com_idx).css('display') == 'none') {
                    ...
                    $(this).find("button span").css({'transform':'rotate(315deg)', 'top':'-2px'});
                }else {
                    $("#term-area-"+cmm_com_idx).slideUp('fast');
                    $(this).find("button span").css({'transform':'rotate(135deg)', 'top':'-8px'});
                }
            });
            ...
            function buttonDisabledToggle() {
                if ($contractFormValidator.checkForm()) {
                    $contractForm.find(".btn-type-text1").removeClass("disabled");
                } else {
                    $contractForm.find(".btn-type-text1").addClass("disabled");
                }
            }
        });
    </script>
