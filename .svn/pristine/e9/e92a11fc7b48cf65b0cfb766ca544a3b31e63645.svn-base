    ...
    <div class="area-content-layer">
        <div class="area-inner">
            ...
            <div class="box-campaign-product">
                ...
                <!-- <div class="box-sns-share" id="no-kakao-sns">
            ...
            <%-- <hr class="divline-type2" id="no-kakao-hr">

            <div class="box-campaign-url" id="no-kakao-url">
...
<%--                                 <p class="url-new"><c:out value="${info.CAMPAIGN_SHORTEN_URL }"/></p> --%>
                            ...
                            <p class="seller-url"><span class="url-new sellerShortUrl btn-seller-short-url">
                                <button class="sellerShortUrl url-new">※ 복수 레디플래너 캠페인 URL 생성
                            </button></span></p>
...
$(document).ready(function () {
    var kakao = navigator.userAgent.includes('KAKAOTALK');
    console.log(kakao);
    if (kakao == true){
        $('#no-kakao-sns').hide();
        $('#no-kakao-hr').hide();
