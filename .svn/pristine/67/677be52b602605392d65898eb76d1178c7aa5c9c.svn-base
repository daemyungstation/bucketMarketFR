...
public class PlannerJoinServiceImpl implements PlannerJoinService {
    ...
    public int insertApplyPlanner(HttpServletRequest request, Map<String, Object> commandMap) throws Exception {
        ...
        if (result > 0) { 
            ...
            List<Map<String, Object>> alimList =  null;
            alimList = (List<Map<String, Object>>) defaultDAO.selectList("PlannerJoin.selectBasicManagerList", commandMap);
            
            for(Map<String, Object> row : alimList) {
                String ADM_MST_HP = StringUtil.getString(row, "ADM_MST_HP");
                String ADM_MST_NM = StringUtil.getString(row, "ADM_MST_NM");
                String RDP_SUB_REG_DT = StringUtil.getString(row, "RDP_SUB_REG_DT");
                this.messageService.sendAlimTalk(MessageType.PLANNER_ADMIN_REQUEST, ADM_MST_HP, ADM_MST_NM, RDP_MST_MEM_NM, RDP_MST_HP, RDP_SUB_REG_DT);
            }
        }
