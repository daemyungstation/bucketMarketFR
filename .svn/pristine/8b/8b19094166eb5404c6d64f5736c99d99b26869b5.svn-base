                    ...
                    <div class="box-detail-product5">
                        <form name="replyRegistForm" id="replyRegistForm" onsubmit="return false">
                            <div class="form-comment">
                                ...
                                <input type="hidden" name="PLN_MST_PSN_YN" value="<c:out value="${info.PLN_MST_PSN_YN }"/>"/>
                                ...
                                <c:if test="${info.PLN_MST_PSN_YN eq 'Y' }">
                                    <div class="box-form" style="clear:both; width:100%;">
                                        <span>
                                            <input type="text" name="PLN_RPL_HP" id="PLN_RPL_HP" class="number" placeholder="연락처를 입력해주세요" maxlength="11" style="width:476px">
                                            <label class="form-alert" message-target="PLN_RPL_HP" data-name="연락처"></label>
                                        </span>
                                    </div>
                                </c:if>
                            </div>
                                    ...
                                    <dl class="box-form">
                                        ...
                                        <dd>
                                            ...
                                            <div class="agreement-checkbox">
                                                <label class="form-checkbox type2" style="float:none;padding-bottom:20px;"><input type="checkbox" name="PLN_RPL_PSN_YN" value="Y">개인정보 수집 및 활용에 동의합니다.</label>
                                                <label class="form-alert" message-target="PLN_RPL_PSN_YN" data-name="개인정보 수집 및 활용에 동의"></label>
                                            </div>
                                        </dd>
                                    </dl>
                                    <dl class="box-form">
                                        ...
                                        <dd>
                                            ...
                                            <div class="agreement-checkbox">
                                                <label class="form-checkbox type2"><input type="checkbox" name="PLN_RPL_MKT_YN" value="Y">마케팅 활용에 동의합니다.</label>
                                            </div>
                                        </dd>
                                    </dl>
                                </div>
                        ...
                        <c:if test="${info.PLN_MST_RPL_EXP_YN eq 'Y' }">
