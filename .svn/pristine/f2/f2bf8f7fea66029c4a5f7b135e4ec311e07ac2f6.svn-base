            ...
            <form id="reviewForm" name="reviewForm">
                ...
                <div class="mypage">
                    <div class="box-information-member">
                        <dl>
                            <dt><c:out value="${SessionsUser.USER_NM }"/></dt>                            
                            <dd class="profile">
                                <c:if test="${contractor.USER_SEX eq Const.MAN}">
                                    <img src="<spring:eval expression="@resource['img.ssl.domain']"/>/resources/pc/images/img_profile_men.png" alt="프로필 사진">
                                </c:if>
                            ...
                            <dd>
                                <ul class="list-type3">
                                    <li class="text-point2">가입상품: <c:out value="${info.PRD_MST_NM }"/></li>
                                    <li class="text-point2">모델분류: <c:out value="${info.MODEL_CL_NM }"/></li>
                                </ul>
                            </dd>
                        </dl>
                    </div>
                    ...
                    <div class="box-reviewmark">
                        <p class="text-normal-type2">상품은 만족하셨나요?</p>
                    ...
                    <div class="box-reviewwrite">
                        <p class="text-normal-type2">고객님의 가입후기를 들려주세요.</p>
