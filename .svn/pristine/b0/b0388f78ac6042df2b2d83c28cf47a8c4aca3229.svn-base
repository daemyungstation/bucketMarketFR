...
<header class="area-header-layer">
    <div class="area-inner">
        <h1 class="title"><c:out value="${commandMap.searchPrdRevBstYn eq 'Y' ? 'BEST' : '' }"/>상품후기 전체보기</h1>
...
<div class="area-content-layer">
    <div class="area-inner latter">
        <h3 class="title">상품후기 (<span class="list-total-count"></span>)</h3>
    ...
    {{else}}
        {{each(i, row) list}}
            <div class="box-latter-view">
                ...
                <p class="latter-name">
                    <span class="latter-name2">\${row.MEM_NM}, \${row.AGE}대</span>
