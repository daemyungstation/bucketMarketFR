...
<jsp:include page="/WEB-INF/jsp/pc/include/nav.jsp" flush="false">
    ...
    <jsp:param name="twoDepth" value="이용가이드"/>
    <jsp:param name="twoDepthKey" value="myplanner.application.guide.view"/>
</jsp:include>
        ...
        <div class="wrap">
            ...
            <div class="contain-body">
                <div class="content-header">
                    <h3 class="title">이용가이드</h3>
                </div>
                
                <div class="contain-planner-guide">
                    <img src="<spring:eval expression="@resource['img.ssl.domain']"/>/resources/pc/images/img_readyplanner_guide_pc.jpg" alt="레디플래너 가이드" />
                </div>
