                ...
                <div class="area-mypage">
                    ...
                    <p class="btn-member">
                        ...
                        <c:if test="${info.CONTRACT_STATUS eq Code.CONTRACT_STATUS_JOIN }">
                            ...
                            <c:if test="${!empty info.encAccntNo }">
                            <span class="btn-type-text7"><button class="certificate" data-no="<c:out value="${info.encAccntNo }"/>">회원증서</button></span>
                            </c:if>
                    ...
                    <div class="table-type1">
                        <table>
                            ...
                            <tr>
                                <th>모델명</th>
                                <td><c:out value="${info.MODEL_CL_NM }"/><c:if test="${info.PRD_MST_MD != ''}"> /  <c:out value="${info.PRD_MST_MD }"/></c:if></td>
                            </tr>
                            <tr>
                                <th>월 납입금</th>
                                <td>
                    ...
                    <div class="table-type1">
                        <table>
                            ...
                            <c:if test="${info.PRD_MST_CD eq 'DMBK202101220201'}">
                                <tr>
                                    <th>펫장례 상품권 번호</th>
                                    <td><c:out value="${info.ORD_MST_IDX }"/></td>
                                </tr>
                            </c:if>
                            <tr>
                                <th>월 지원금</th>
