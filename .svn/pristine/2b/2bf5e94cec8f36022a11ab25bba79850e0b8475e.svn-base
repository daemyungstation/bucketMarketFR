...
<jsp:include page="/WEB-INF/jsp/mo/include/header.jsp" flush="false">
    ...
    <jsp:param name="headerTitle" value="실적현황조회"/>
</jsp:include>
<!-- //헤더 -->
<!-- 카테고리 -->
    ...
    <div class="contain-reward">
        ...
        <div class="box-tab-body tab3">
            <div class="box-reward-inner">
                ...
                <!-- start -->
                <div class="box-reward-search">
                    <h2>조회기간&nbsp;&nbsp;&nbsp;<button class="btn-down" id="productDownBtn">엑셀다운로드</button></h2>
                    <span class="form-calendar">
                        <span>
    ...
    $(function () {
        ...
        $areaContent.on("click", ".list-detail", function(){
            var param = {
                    searchStartDate : $productSearchStartDate.val(),
                    searchEndDate : $productSearchEndDate.val(),
                    searchContractType : $(this).data("type"),
                    searchPrdMstNm : $(this).data("nm")
                };
            $(".layer-popup1").requestLayer($.action.myplanner.performance.product.history(), param );
        });
        //상품별 엑셀 다운로드
        $areaContent.on("click", "#productDownBtn", function(){
            $.requestPage($.action.myplanner.performance.product.down(), {});
        });
    });
</script>
