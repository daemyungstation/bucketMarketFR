        ...
        <form name="replyForm" id="replyForm" onsubmit="return false">
            ...
            <div class="contain-comment">
                <span class="form-textarea">
                    <textarea name="EVT_RPL_CTS" id="EVT_RPL_CTS" placeholder="해피콜 가능한 시간을 남겨주세요. (예시 4/20 오후4~5시) #콜센터 운영시간: 평일 10:00~19:00." onkeyup="StringUtil.getStrLength(this, '.byte', 600);" maxlength="600"><c:out value="${info.EVT_RPL_CTS }"/></textarea>
