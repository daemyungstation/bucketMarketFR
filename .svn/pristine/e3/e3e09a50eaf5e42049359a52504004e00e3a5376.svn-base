...
public class DateTag extends TagSupport {
    ...
    public String resultView(String d, String p) throws JspException {
        ...
        if (d.length() == 14) {
            ...
            Date td = new Date(StringUtil.getInt(d.substring(0, 4)) - 1900, StringUtil.getInt(d.substring(4, 6)) - 1, StringUtil.getInt(d.substring(6, 8)), StringUtil.getInt(d.substring(8, 10)), StringUtil.getInt(d.substring(10, 12)),
            ...
            Date td = new Date(StringUtil.getInt(d.substring(0, 4)) - 1900, StringUtil.getInt(d.substring(4, 6)) - 1, StringUtil.getInt(d.substring(6, 8))
            /*
