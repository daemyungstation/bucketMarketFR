...
<head>
    ...
    <link rel="canonical" href="<spring:eval expression="@resource['front.ssl.domain']"/>">
</head>
        ...
        <div class="contain-body">
            ...
            <c:if test="${not empty info.exhibition }">
                ...
                <section class="section-main2">
                    <div class="contain-inner">
                        <h2 class="title"><span>꿈꾸던 삶을 위한 <br >특별 기획전.</span></h2>
                                            ...
                                            <dl class="detail-product-type1 type3">
                                                <dd class="image">
                                                    ...
                                                    <c:if test="${not empty product.PRD_MST_SPT_TXT }">
                                                        <c:if test="${product.PRD_MST_TYPE eq Code.PRODUCT_TYPE_RENTAL}">
