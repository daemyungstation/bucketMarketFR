...
<section class="area-navigation-global">
    <div class="area-inner">
        <div class="contain-category">
            ...
            <span class="btn-link"><a href="javascript:$.requestPage($.action.display.product.list());">베스트</a></span>
            ...
            <span class="btn-tag"><a href="javascript:$.requestPage($.action.display.curation.list());">#나만을 위한 추천</a></span>
        </div>
