...
<jsp:include page="/WEB-INF/jsp/pc/include/nav.jsp" flush="false">
    ...
    <jsp:param name="twoDepth" value="맵버십카드 조회"/>
    <jsp:param name="twoDepthKey" value="mycontract.membership.list.view"/>
</jsp:include>
        ...
        <div class="wrap">
            ...
            <div class="contain-body">
                <div class="content-header">
                    <h3 class="title">멤버십 카드 조회</h3>
                </div>
                
                <div class="area-mypage">
                    <div class="box-information">
                        <ul class="text-information-list1">
                            <li>가입하신 상품의 멤버십 카드를 조회할 수 있습니다.</li>
                        </ul>
                    </div>
...
<script>
    $(function () {
        ...
        $areaContent.on("click", "button.membership", function() {
            ...
            $(".layer-popup1").requestLayer($.action.mycontract.membership.view.layer(), params, "layer-member1");
        });
    });
</script>
