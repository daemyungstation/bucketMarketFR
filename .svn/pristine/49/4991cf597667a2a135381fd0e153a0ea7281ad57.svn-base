        ...
        <div class="contain-login">
            ...
            <form id="frm" name="frm">
                ...
                <div class="contain-join-body">
                    ...
                    <p class="text-information-type1">
                        버킷마켓 상품 홍보를 위한<br>
                        레디플래너 정보를 입력해 주세요.
                        <span class="text-notice-type2 form">* 필수</span>
                    </p>
                    ...
                    <dl class="box-form">
                        <dt class="necessary">홍보사이트 (http://, https:// 포함 입력)<span class="text-addtion">1개 이상 필수</span></dt>
                        <dd id="siteAddressList">
                            <span class="form-addbutton">
                                <input type="text" id="siteAddress" placeholder="http://" maxlength="33">
                            ...
                            <label class="form-alert" message-target="RDP_SIT_ADRs_CHECK" data-name="홍보사이트"></label>
